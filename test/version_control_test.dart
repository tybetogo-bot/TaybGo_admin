...
void main() {
  testWidgets('renders the version history and release dates', (tester) async {
    ...
    expect(find.textContaining('1.0.11+12'), findsNWidgets(2));
    expect(find.textContaining('1.0.10+11'), findsOneWidget);
    ...
    expect(
      find.textContaining('Released September 11, 2026'),
      findsNWidgets(2),
    );
    expect(find.textContaining('Released August 24, 2026'), findsOneWidget);
